    ...
    */
    ...
    const handleUpdate = async e => {
        ...
        try{
            ...
            await axios.put("http://localhost:8800/departments/"+ departmentName, department); // This is the api call we wrote for put requests to our database in order to update.
            navigate("/departments") // If everything was successful navigate to the home page. 
        }catch(err){
            console.log(err)
        }
    }
