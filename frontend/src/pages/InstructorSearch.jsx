...
const Instructors = () => {
    ...
    const filteredInstructors = instructors.filter(instructor => 
        instructor.Instructor_Name.toLowerCase().includes(searchTerm) ||
        ...
        (instructor.Inst_Dep && instructor.Inst_Dep.toLowerCase().includes(searchTerm))
    );
    ...
    return (
        ...
        <div className="courses">
            ...
            {filteredInstructors.map(instructor => (
                <div className="instructor" key={`${instructor.Teacher_ID}`}> 
                    <h2>{instructor.Instructor_Name}</h2>
                    <span><b>Department: </b> {instructor.Inst_Dep}, </span> 
                </div>
            ))}
        </div>
    </div>
